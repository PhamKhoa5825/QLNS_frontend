...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentUserId = SharedPrefsManager.getInstance(this).getEmployeeId(); // Using employeeId as userId for simplicity in this app context
    ...
    private void startPolling() {
        pollingRunnable = new Runnable() {
            @Override
            public void run() {
                fetchMessages(); // Simple full refresh for now, backend supports 'new' but this is robust for demo
