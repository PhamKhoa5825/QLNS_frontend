...
public class ChatForegroundService extends Service {
    ...
    private static final String MSG_CHANNEL_ID = "chat_messages_channel";
    ...
    private void connectWebSocket(String token, List<ChatRoom> rooms) {
        String wsUrl = "ws://10.0.2.2:8080/ws/websocket"; // Match your RetrofitClient host
    ...
    private Notification createForegroundNotification() {
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                .setContentTitle("HRM App Chat")
                .setContentText("Đang kết nối chat")
                .setSmallIcon(R.mipmap.ic_launcher)
